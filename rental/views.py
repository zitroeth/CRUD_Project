...
from .serializers import CustomTokenObtainPairSerializer, CustomTokenGenerator
...
class SentimentAnalysisViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        sentiment_analysis = models.SentimentAnalysis(text=text, sentiment=sentiment, score=sentiment_result['score'], token=request.user.token)
